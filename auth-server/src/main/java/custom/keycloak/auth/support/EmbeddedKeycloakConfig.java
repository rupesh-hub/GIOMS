...
import custom.keycloak.auth.support.support.DynamicJndiContextFactoryBuilder;
import custom.keycloak.auth.support.support.KeycloakUndertowRequestFilter;
import custom.keycloak.auth.support.support.SpringBootConfigProvider;
import custom.keycloak.auth.support.support.SpringBootPlatform;
...
public class EmbeddedKeycloakConfig {
    ...
    protected DynamicJndiContextFactoryBuilder springBeansJndiContextFactory(
            @Qualifier("secondDataSource")
                    DataSource dataSource, DefaultCacheManager cacheManager) {
