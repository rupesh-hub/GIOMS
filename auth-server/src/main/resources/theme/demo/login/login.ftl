...
<div class="card card-3">
    ...
    <div class="card-body">
        ...
        <form id="kc-form-login" class="form form1" return true;
        " action="${url.loginAction}" method="post">
        <div class="input-group">
            <label>Username*</label>
            <div>
                <input id="username" class="input--style-3 input-width" type="text" placeholder="Username"
                       name="username">
            </div>
        </div>
        <div class="input-group">
            ...
            <div>
                <input class="input--style-3 input-width" id="txtPassword" type="password" placeholder="Password"
                       name="password">
            </div>
        </div>
