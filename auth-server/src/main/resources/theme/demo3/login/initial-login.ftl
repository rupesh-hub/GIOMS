...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "form">
        <div class="login-form">
            ...
            <form return true;
            " action="${url.loginAction}" method="post" id="initialLogin">
            <div class="form-group">
                <label for="" class="d-block">
                    <div class="align-vertical justify-content-between">
                        <span class="d-block">${msg("oldPassword")}*</span>
                ...
                <div class="form-control-icon rft">
                    <input id="hideUnhidePsw3" type="password" class="form-control" name="password-old"/>
                    <a id="hideUnhide3" href="#" class="ic-hidden"></a>
                </div>
            </div>
            <div class="row ">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="">${msg("newPassword")}*</label>
                        <div class="form-control-icon rft">
                            <input id="hideUnhidePsw4" type="password" class="form-control" name="password-new"/>
                            <a id="hideUnhide4" href="#" class="ic-hidden"></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <div class="form-control-icon rft">
                            <input id="hideUnhidePsw5" type="password" class="form-control" name="password-confirm"/>
                            <a id="hideUnhide5" href="#" class="ic-hidden"></a>
                        </div>
                    </div>
                </div>
            </div>
