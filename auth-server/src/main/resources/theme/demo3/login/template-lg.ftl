...
<#--    </div>-->
    ...
    <script type="text/javascript" src="${url.resourcesPath}/css/initial-login.js"></script>
    ...
    <script type="text/javascript">
        ...
        $('#hideUnhide1').on('click',function () {
            if($(this).attr('class')=='ic-hidden'){
                $('#hideUnhidePsw1').get(0).type = 'text';
                $(this).toggleClass('ic-hidden');
                $(this).toggleClass('ic-visible');
            }else{
                $('#hideUnhidePsw1').get(0).type = 'password';
                $(this).toggleClass('ic-visible');
                $(this).toggleClass('ic-hidden');
            }
        })

        $('#hideUnhide2').on('click',function () {
            if($(this).attr('class')=='ic-hidden'){
                $('#hideUnhidePsw2').get(0).type = 'text';
                $(this).toggleClass('ic-hidden');
                $(this).toggleClass('ic-visible');
            }else{
                $('#hideUnhidePsw2').get(0).type = 'password';
                $(this).toggleClass('ic-visible');
                $(this).toggleClass('ic-hidden');
            }
        })

        $('#hideUnhide3').on('click',function () {
            if($(this).attr('class')=='ic-hidden'){
                $('#hideUnhidePsw3').get(0).type = 'text';
                $(this).toggleClass('ic-hidden');
                $(this).toggleClass('ic-visible');
            }else{
                $('#hideUnhidePsw3').get(0).type = 'password';
                $(this).toggleClass('ic-visible');
                $(this).toggleClass('ic-hidden');
            }
        })

        $('#hideUnhide4').on('click',function () {
            if($(this).attr('class')=='ic-hidden'){
                $('#hideUnhidePsw4').get(0).type = 'text';
                $(this).toggleClass('ic-hidden');
                $(this).toggleClass('ic-visible');
            }else{
                $('#hideUnhidePsw4').get(0).type = 'password';
                $(this).toggleClass('ic-visible');
                $(this).toggleClass('ic-hidden');
            }
        })

        $('#hideUnhide5').on('click',function () {
            if($(this).attr('class')=='ic-hidden'){
                $('#hideUnhidePsw5').get(0).type = 'text';
                $(this).toggleClass('ic-hidden');
                $(this).toggleClass('ic-visible');
            }else{
                $('#hideUnhidePsw5').get(0).type = 'password';
                $(this).toggleClass('ic-visible');
                $(this).toggleClass('ic-hidden');
            }
        })
