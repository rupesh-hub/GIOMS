...
@Component
public class AbsentEmployeeReportGenerator {
...
//                        "<h3>"+ topOfficeDetails.get(topOfficeDetails.size()-1) +"</h3>\n" +
                            "<span style=\"font-size:14px\">"+userMgmtMapper.getActiveFiscalYear(1)+"Absent report of "+ StringUtils.capitalize(userType)+"Employee</span><br><br>"+
                            "<div>";
        }else {
            htmlcheck =
                    htmlcheck +
//                        "<h3>"+ topOfficeDetails.get(topOfficeDetails.size()-1) +"</h3>\n" +
                            "<span style=\"font-size:14px\">" + userMgmtMapper.getActiveFiscalYear(1) + "Absent report of Employee</span><br><br>" +
                            "<div>";
        }
    ...
    public String generateNepaliReport(GetRowsRequest paginatedRequest) {
        ...
        if(paginatedRequest.getSearchField().get("userType")!=null){
            ...
            htmlcheck=
                    htmlcheck +
//                        "<h3>"+ topOfficeDetails.get(topOfficeDetails.size()-1) +"</h3>\n" +
                            "<span style=\"font-size:14px\">"+userMgmtMapper.getActiveFiscalYear(0)+" को "+StringUtils.capitalize(userType)+" कर्मचारी को अनुपस्थित रिपोर्ट</span><br><br>"+
            ...
            htmlcheck =
                    htmlcheck +
//                        "<h3>"+ topOfficeDetails.get(topOfficeDetails.size()-1) +"</h3>\n" +
                            "<span style=\"font-size:14px\">"+userMgmtMapper.getActiveFiscalYear(0)+" को कर्मचारीको अनुपस्थित रिपोर्ट</span><br><br>"+
...
//                " <span style=\"display: flex; justify-content: deflex;\">...................................</span>" +
//                " <span style=\"display: flex; justify-content: deflex;\">तयारी  गर्ने</span>" +
//                "</div>" +
//                " <div colspan=\"3\">" +
//                " <span style=\"display: flex; justify-content: deflex;\">...................................</span>" +
//                "<span style=\"display: flex; justify-content: deflex;\">पेस गर्ने</span>" +
//                "</div>" +
//                "<div colspan=\"3\">" +
//                "<span style=\"display: flex; justify-content: deflex;\">...................................</span>" +
//                "<span style=\"display: flex; justify-content: deflex;\">प्रमाणित गर्ने</span>" +
//                "</div>" ;
        htmlcheck = htmlcheck.concat(pdfNepaliFooter);
        return htmlcheck;
    }
