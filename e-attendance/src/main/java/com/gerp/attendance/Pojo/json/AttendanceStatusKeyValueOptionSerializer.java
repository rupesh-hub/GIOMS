...
@Configuration
public class AttendanceStatusKeyValueOptionSerializer extends StdSerializer<Enum> {

    public AttendanceStatusKeyValueOptionSerializer() {
        this(null);
    }

    protected AttendanceStatusKeyValueOptionSerializer(Class<Enum> t) {
        super(t);
    }
    ...
    private KeyValuePojo _getSerializedData(Enum s) {
        return AttendanceStatus.valueOf(s.toString()).getEnum();
    }
}
