package com.gerp.attendance.config.interceptor.feign;
...
public class FeignClientInterceptor implements RequestInterceptor {
    ...
    private static final String SERVICE = OperationConstants.DARTA_CHALANI;
    ...
    public void apply(RequestTemplate requestTemplate) {
        ...
        if (authentication != null && authentication.getDetails() instanceof SimpleKeycloakAccount) {
            ...
            requestTemplate.header(OperationConstants.MODULE_SERVICE_TYPE, ModuleType.EATTENDANCE);
        }
    }
}
