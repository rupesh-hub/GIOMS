...
//                .antMatchers(ROOT_PATTERN).permitAll()
                .antMatchers("/swagger-ui.html", "/actuator/prometheus", "/swagger-ui/**", "/v3/api-docs", "/v3/api-docs/**","/manual-attendance/download").permitAll()
                .antMatchers(HttpMethod.POST,"/employee-attendance/real-time-update").permitAll()
                .antMatchers(HttpMethod.POST,"/device-test/hit-check").permitAll()
