...
@Component
public class DartaChalaniServiceFallback extends BaseController implements DartaChalaniServiceProxy {
    private Exception exception;

    public DartaChalaniServiceFallback injectException(Exception cause) {
        exception = cause;
        return this;
    }
    ...
    private GlobalApiResponse getResponse() {
        ...
        if (exception.equals("com.netflix.client.ClientException"))
            message = customMessageSource.get("service.not.available", customMessageSource.get(DartaChalaniServiceProxy.SERVICE_NAME));
