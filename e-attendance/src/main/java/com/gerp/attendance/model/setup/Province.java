...
//@DynamicUpdate
//@Table(name = "province", uniqueConstraints = @UniqueConstraint(name = "UNIQUE_province_name", columnNames = "name_np"))
//public class Province extends AuditActiveAbstract {
//    @Id
//    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "province_seq_gen")
//    @SequenceGenerator(name = "province_seq_gen", sequenceName = "seq_province", initialValue = 1, allocationSize = 1)
//    private Long id;
//
//    @NotNull
//    @NotBlank
...
//    @JoinColumn(name = "country_id", referencedColumnName = "id", foreignKey = @ForeignKey(name = "FK_Province_Country"))
