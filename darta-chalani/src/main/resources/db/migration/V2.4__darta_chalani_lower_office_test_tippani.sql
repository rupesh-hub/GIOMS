CREATE OR REPLACE FUNCTION public.darta_chalani_lower_office_test_tippani(fromdate character varying, todate character varying, limits integer, offsets integer, lowerofficelist character varying, ordertype character varying)
...
BEGIN
    dynamicQuery :='
            ...
            from
                ...
                )as c on ti.m_office_code=c.sender_office_code) q3 order by q3.approvedTippadi '||ordertype||' limit '''||limits||''' offset '''||offsets||'''
        )';
