CREATE OR REPLACE FUNCTION public.darta_chalani_lower_office_test_chalani_excel(fromdate character varying, todate character varying, lowerofficelist character varying, ordertype character varying)
    ...
    dynamicQuery :='
        (
            ...
            from
                ...
                )as ti on ti.m_office_code=dr.office_code) q2 order by q2.approvedChalani '||ordertype||'
        )';
